...
| 2.5 | [2.5.planner-executor-sonnet.md](./2.5.planner-executor-sonnet.md) | Planner + Executor (Sonnet) + atomicidade Postgres | **Ready** (v1.1 — @po GO 9.4/10 high; aguarda @dev) | @dev | L | Depende 2.3 ✓ + 2.4 ✓; EB1 PENDING (não bloqueia drafting/dev/gate — mockable-only padrão 2.2/2.3/2.4) |

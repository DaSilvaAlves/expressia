...
| 2.8 | [2.8.undo-inngest-cleanup-ui.md](./2.8.undo-inngest-cleanup-ui.md) | Undo mechanism (FR6) + Inngest cleanup + UI Undo button | **Draft** v1.0 | @sm → @po → @dev | M | Depende 2.6 ✓ + EB4 (Inngest workspace EU — non-blocking, Eurico provisiona pre-push) |

# Landing Page iris — Final Copy v1.0

**Author:** @ux-design-expert (Uma)
**Date:** 2026-05-06
**Target URL:** https://iris.pt
...
| **Sub-headline**                              | O iris é o assistente em português que organiza as tarefas, as finanças e a agenda da tua família — numa só conversa.                                                                                                                                                                                                                                                                                                       |
| **Visual**                                    | Mockup estático da app (dark mode / minimalist) a mostrar o chat principal num split layout. À esquerda o utilizador escreveu "Paguei 50€ no Continente para o jantar de família e marca a consulta da Joana terça às 10h"; à direita o painel mostra duas confirmações (uma transação de €50,00 na categoria Alimentação + uma tarefa "Consulta Joana"). Background preto profundo `#000000` com sombra suave e pó dourado. |
| **Primary CTA**                               | `Começar grátis 14 dias` (botão Ouro/Branco, radius-md)                                                                                                                                                                                                                                                                                                                                                    |
...
| **Visual**                    | Ilustração linha-fina (3 cartões diagonais sobrepostos representando "Calendário", "WhatsApp lembretes", "Excel orçamento") com setas a apontarem para um único cartão limpo "iris" — Estilo editorial, não estilo "infográfico tech". |
...
| Elemento             | Conteúdo                                                                                                                                       |
| -------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- |
| **H2**               | Escreve uma frase. O iris faz o resto.                                                                                                    |
...
**Resposta do iris (cartão Ouro/Branco à esquerda):**
...
| **Subheading** | A maioria das apps de produtividade são feitas para uma pessoa. As que tentam ser para famílias adicionam isso depois, com convites por email e permissões mal feitas. O iris começou ao contrário. |
...
| **Subheading** | O iris é open-source AGPL-3.0. Podes ver o código, propor melhorias, ou levá-lo para self-host se preferires. |

**3 elementos em linha horizontal (desktop) ou stack (mobile):**

| Elemento                   | Conteúdo                                                                                                                           |
| -------------------------- | ---------------------------------------------------------------------------------------------------------------------------------- |
| **Badge GitHub**           | Visual: ícone GitHub + "DaSilvaAlves/iris" + contadores stars/issues (real, fetch via API ou estático MVP). Link para o repo. |
...
- Logo iris (wordmark Lora) à esquerda
- Centro: `© 2026 iris. Construído em Portugal.`
...
| **Posicionamento** | O membro/utilizador é o herói. O iris é o guia. Nunca virar isto.                                                            |

### 3.2 Vocabulário PROIBIDO (PT-BR ou demasiado tech)

| Proibido   | Substituir por                                           |
| ---------- | -------------------------------------------------------- |
| App        | Aplicação (em copy formal) ou "o iris" (preferível) |
...
<html lang="pt-PT">
  <head>
    ...
    <title>
      iris — Assistente em português para tarefas, finanças e agenda da família | €8,88/mês
    </title>
    <meta
      name="description"
    ...
    />
    <link rel="canonical" href="https://iris.pt" />

    <!-- Open Graph -->
    <meta property="og:type" content="website" />
    <meta property="og:locale" content="pt_PT" />
    <meta property="og:title" content="iris — Uma frase. Tudo organizado." />
    <meta
      property="og:description"
      content="Assistente em português para tarefas, finanças e agenda da família. €8,88/mês. Trial 14 dias sem cartão."
    />
    <meta property="og:image" content="https://iris.pt/og-image.png" />
    <meta property="og:url" content="https://iris.pt" />
    <meta property="og:site_name" content="iris" />

    <!-- Twitter / X -->
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:title" content="iris — Uma frase. Tudo organizado." />
    <meta
      name="twitter:description"
      content="Assistente em português para tarefas, finanças e agenda da família. €8,88/mês."
    />
    <meta name="twitter:image" content="https://iris.pt/og-image.png" />
...
- alternativa portuguesa ao iris
...
| **Footer GitHub badge**    | Componente que faz fetch GitHub stars (fallback estático no SSR Vercel). Link directo para `github.com/DaSilvaAlves/iris`.                           |
...
| OG image (`og-image.png`)        | 1200x630                 | PNG                 | "iris — Uma frase. Tudo organizado." sobre creme `#FAFAF7` con mockup pequeno |
...
| --- | ---------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Q1  | Logo final existe ou ainda é text-based "iris"?                                                       | **Wordmark Lora 600 (text-based) para MVP**, símbolo+wordmark depois. Justificação: front-end-spec §2.2 já descreve concept; wordmark sozinho aceita-se em MVP. |
...
Antes de pôr a landing pública (`iris.pt` → produção), tem que estar feito:
...
| 6   | Domínio `iris.pt` configurado em Vercel             | @devops                     | **SIM** — produção                                |
...
| 9   | Trademark INPI Portugal verificado para "iris"      | @analyst                    | **SIM** — risco legal antes de lançamento público |
